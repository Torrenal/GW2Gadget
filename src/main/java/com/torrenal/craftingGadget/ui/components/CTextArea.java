...
//	   	new Error("Invalid Invocation: Invoked from Event Thread").printStackTrace();
   ...
   {
	   warnIfOffEventThread();
	   return super.print(headerFormat, footerFormat);
   }

	@Override
   public boolean print(MessageFormat headerFormat, MessageFormat footerFormat,
         boolean showPrintDialog, PrintService service,
         PrintRequestAttributeSet attributes, boolean interactive)
         throws PrinterException
   {
	   warnIfOffEventThread();
	   return super.print(headerFormat, footerFormat, showPrintDialog, service,
   ...
   {
	   warnIfOffEventThread();
	   return super.saveComposedText(pos);
   }
   ...
   {
	   warnIfOffEventThread();
	   super.setFocusAccelerator(aKey);
   }
