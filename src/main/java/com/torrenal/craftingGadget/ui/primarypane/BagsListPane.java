...
import com.torrenal.craftingGadget.ui.BagsList;
...
public class BagsListPane extends JPanel implements PrimaryPaneInterface
{
   ...
   public JMenu[] getPaneMenues()
   {
      ...
      synchronized(syncObject)
      {
         ...
         for(ColumnType column : ColumnType.values())
         {
            ...
            menuItem.addActionListener(bagsList);
            menu[0].add(menuItem);
         }
         this.menu = menu;
      }
